<?php
	...
	if ($alumnos->num_rows >= 1):
		...
		WHERE no_control = '".$no_control."' AND calificaciones_semestrales.tipo_acreditacion = 'NP' AND 
		calificaciones_semestrales.nombre_asignatura = materias.nombre_asignatura");
