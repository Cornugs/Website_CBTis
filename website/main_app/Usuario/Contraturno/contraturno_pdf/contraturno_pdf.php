<?php
	...
	if ($numero_pdf == 1)
	{
		...
		$mysqli->query("INSERT INTO pdfs_contraturno(fecha, periodo, no_control, nombre_alumno, grupo, 
		...
		$mysqli->query("UPDATE pdfs_contraturno SET folio = @num := (@num+1)");
		$ultimo_pdf = $mysqli->query("SELECT folio FROM pdfs_contraturno ORDER BY folio DESC LIMIT 1");
		...
		$pdf->Cell(185, 10, 'Solicitud de pago para recursamiento en contraturno', 0, 0, 'C');
		$pdf->Ln(12);
		...
		$pdf->SetTextColor(0, 0, 0);
		$pdf->Cell(15, 10, "JC19".$folio, 0, 0, 'L');
		$pdf->Ln(6);
		$pdf->SetTextColor(33, 40, 246);
		...
		$pdf->Output('', 'Solicitud_Contraturno_Folio_'.$folio.'.pdf', true);
