    ...
    <body>
        ...
        <div class="container-fluid">
            <header class="row justify-content-center">
                <div class="div_sdppeee">
                    <h1 align="center" class="h1_sdppeee">Solicitud de pago para el examen extraordinario</h1>
                </div>
            </header>
			...
			<section class="row justify-content-center">
				<div class="div_materias_no_reprobadas" align="center">
					<div class="col justify-content-center text-center div_materias_no_resprobadas_2">
						<h1 class="ntnmr">No tienes ninguna materia de tronco común reprobada.</h1>
		...
		<script src="../../../js/extraordinario_2.js"></script>
		<script src="../../../js/extraordinario_3.js"></script>
    </body>
</html>