    ...
    <body>
        ...
        <div class="container-fluid">
            <header class="row justify-content-center">
                <div class="div_sdppci">
                    <h1 align="center" class="h1_sdppci">Solicitud de pago para cursos intersemestrales</h1>
                </div>
            </header>
			...
			<section class="row justify-content-center">
				<div class="div_materias_no_reprobadas" align="center">
					<div class="col justify-content-center text-center div_materias_no_resprobadas_2">
						<h1 class="ntnmr">No tienes ninguna materia de especialidad reprobada.</h1>
        ...
        <script src="../../../js/intersemestral.js"></script>
		<script src="../../../js/intersemestral_2.js"></script>
		<script src="../../../js/intersemestral_3.js"></script>
    </body>
</html>